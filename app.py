...
DEFAULT_SERVICES = [
    ...
    ("Renovation & Maintenance Works", "Civil repair, structural improvement, and maintenance works for existing buildings, drainage systems, compound walls, and other infrastructure assets.", "tools", 6),
]
...
def init_db():
    ...
    if not AboutContent.query.get(1):
        db.session.add(AboutContent(
            id=1,
            short_description="Udyam-registered, GST-compliant civil contractor with on-ground experience in coastal works, municipal construction, and site execution across South Tamil Nadu.",
            full_description="M-GROUPS INFRA PROJECTS is a registered civil engineering and infrastructure contractor operating out of Nagercoil, Kanniyakumari, Tamil Nadu. Founded with a focus on disciplined site management and quality execution, the company serves government bodies, municipal corporations, and private clients across South Tamil Nadu.\n\nWe handle projects from initial site planning through to final handover — coordinating labour, materials, subcontractors, and compliance documentation under one roof.",
            mission="To deliver reliable civil infrastructure works with honest timelines, safe site practices, and workmanship that holds up long after project handover.",
            vision="To be the most dependable civil contractor in Kanniyakumari and surrounding districts — the name clients, corporations, and government bodies call first.",
            core_values="Quality Workmanship\nSafety on Every Site\nTimely Delivery\nTransparent Communication\nResponsible Site Management",
            experience_summary="Our work spans coastal infrastructure, overhead tank construction, municipal support works, and waterway-related civil projects. Key documented project areas include Nagercoil Municipal Corporation, 79 Coastal Works, Gopalasamuthiram, Thenthiruparai, Kadukkarai & Kattuputhur, and Dindigul.",
